...
var SSE = function (url, options) {
  ...
  this.trimData = options.trimData !== undefined ? options.trimData : false;
  ...
  this._parseEventChunk = function(chunk) {
    ...
    chunk.split(/\n|\r\n|\r/).forEach(function(line) {
      ...
      if (index > 0) {
        ...
        const skip = (line[index + 1] === ' ') && !this.trimData ? 2 : 1;
 ...
 * @property {boolean} [trimData] - flag, if data should be trimmed
